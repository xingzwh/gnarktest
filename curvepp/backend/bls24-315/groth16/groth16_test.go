...
import (
	...
	"github.com/xingzwh/gnarktest/curvepp/backend/bls24-315/cs"

	bls24_315witness "github.com/xingzwh/gnarktest/curvepp/backend/bls24-315/witness"

	"bytes"
	bls24_315groth16 "github.com/xingzwh/gnarktest/curvepp/backend/bls24-315/groth16"
	"reflect"
	"testing"
...
func BenchmarkVerifier(b *testing.B) {
	...
	b.Run("verifier", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			_ = bls24_315groth16.Verify(proof, &vk, publicWitness)
		}
	})
}
...
func BenchmarkProofSerialization(b *testing.B) {
	...
	b.Run("proof: binary serialization (bls24_315groth16.Proof)", func(b *testing.B) {
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
	...
	b.Run("proof: binary deserialization (bls24_315groth16.Proof)", func(b *testing.B) {
		var buf bytes.Buffer
		_, _ = proof.WriteTo(&buf)
	...
	// ---------------------------------------------------------------------------------------------
	// bls24_315groth16.Proof binary serialization (uncompressed)
	b.Run("proof: binary raw serialization (bls24_315groth16.Proof)", func(b *testing.B) {
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			var buf bytes.Buffer
	...
	b.Run("proof: binary raw deserialization (bls24_315groth16.Proof)", func(b *testing.B) {
		var buf bytes.Buffer
		_, _ = proof.WriteRawTo(&buf)
		var proofReconstructed bls24_315groth16.Proof
		b.ResetTimer()
